<template>
  <div class="absolute flex items-center text-white text-sm font-bold px-4 py-3 w-full mb-4 animated tada" role="alert"
    v-if="info.message" :class="alertClass" style="animation-delay: 1s;">
    <svg class="h-4 w-4 fill-current text-white mr-4" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
      ...
      v-if="info.type === MESSAGE_TYPES.error">
      <g>
    ...
    <svg class="fill-current h-4 w-4 text-white mr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" v-else-if="info.type === MESSAGE_TYPES.warning">
    ...
    <span class="absolute pin-t pin-b pin-r px-4 py-3" @click="info.state = false">
