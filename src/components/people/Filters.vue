  ...
  <div class="mt-6 py-1 filters" id="filters">
    ...
    <div class="mt-6">
      <div class="w-full mt-6">
        ...
        <div class="mt-2 w-full">
          <div class="w-full inline-flex items-center justify-center relative p-1">
            ...
            <input
              class="appearance-none w-full p-1 h-10 pl-8 text-grey bg-grey-lighter rounded border focus:bg-white border-transparent focus:border-blue-light border-animated"
              type="text"
      ...
      <div class="w-full mt-6">
        ...
        <div class="mt-2 w-full">
          <div
            class="mt-2 w-full inline-flex relative"
            v-for="field in requiredFields"
            :key="field.id"
          >
            <p class="flex-grow text-grey-dark">{{field.text}}</p>
        ...
        <div class="mt-2 w-full inline-flex items-center justify-between">
          <div class="mt-2 w-1/2 mr-1">
            ...
            <input
              ...
              class="w-full text-grey-darker h-10 inline-flex border rounded-sm mb-1 pl-2"
              name="Start Date"
              ref="start_date_joined"
              id="Start Date"
              :class="getInputColor('Start Date')"
            >
            <p
              class="text-red-light text-xs italic pt-1 animated shake h-4"
              v-show="getInputState('Start Date')"
          ...
          <div class="mt-2 w-1/2 ml-1">
            ...
            <input
              ...
              ref="end_date_joined"
              id="End Date"
              :class="getInputColor('End Date')"
            >
            <p
              class="text-red-light text-xs italic pt-1 animated shake h-4"
              v-show="getInputState('End Date')"
      ...
      <div class="w-full mt-6">
        ...
        <div class="mt-2 w-full">
          <on-click-outside :do="handleGroupSearchOutside">
            <div class="mt-2 relative mx-auto">
              ...
              <div
                v-show="groups.searched.length"
                class="mt-px text-sm text-center shadow-md text-grey-darker leading-normal rounded bg-white border absolute pin-l animated zoomIn flex flex-col overflow-hidden w-full max-w-sm z-10"
              >
                <a
                  v-for="group in groups.searched"
                  :key="group.id"
                  class="cursor-pointer no-underline flex items-center px-4 py-3 border-b whitespace-no-wrap group hover:text-white hover:bg-blue-light"
        ...
        <div class="mt-8 inline-flex justify-start w-full">
          <div class="w-full inline-flex justify-between items-center">
            <button
              class="inline-flex flex-auto items-center justify-center h-10 bg-blue rounded-sm text-white shadow-md mr-2"
              @click="filterPeople"
            >
              <span class="font-bold">APPLY FILTER</span>
              <svg
                class="spinner ml-2 h-6 w-6 text-grey-light fill-current animated fadeIn"
                version="1.1"
                xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink"
                x="0px"
            ...
            <button
              class="inline-flex flex-auto items-center justify-center h-10 rounded-sm text-blue-light underline ml-2"
              @click="$emit('close')"
            >
