  ...
  <div class="w-full">
    ...
    <div class="mt-8 flex flex-wrap items-center justify-between">
      ...
      <div class="control mb-4 w-full">
        ...
        <input type="text" class="w-full text-grey-darker h-10 inline-flex border rounded-sm mb-1 pl-2" v-model="first_name"
          name="First Name" tabindex="1" id="First Name" :class="getInputColor('First Name')">
      ...
      <div class="control mb-4 w-full">
        ...
        <input type="text" class="w-full text-grey-darker h-10 inline-flex border rounded-sm mb-1 pl-2" v-model="last_name"
          name="Last Name" tabindex="1" id="Last Name" :class="getInputColor('Last Name')">
      ...
      <div class="control mb-4 w-full">
        ...
        <input type="text" class="w-full text-grey-darker h-10 inline-flex border rounded-sm mb-1 pl-2" v-model="other_names"
          name="Other Name" tabindex="1" id="Other Name" :class="getInputColor('Other Name')">
...
<script>
  ...
  export default {
    ...
    methods: {
      setPersonDetails(){
        this.other_names = this.personDetails.other_names
        this.date_of_birth = this.personDetails.date_of_birth
        this.place_pf_birth = this.personDetails.place_pf_birth
        this.gender = this.personDetails.gender
        this.house_number = this.personDetails.house_number
        this.street_name = this.personDetails.street_name
        this.location = this.personDetails.location
        this.hometown = this.personDetails.hometown
        this.hometown_address = this.personDetails.hometown_address
        this.education_level = this.personDetails.education_level
        this.occupation = this.personDetails.occupation
        this.cell_phone_1 = this.personDetails.cell_phone_1
        this.cell_phone_2 = this.personDetails.cell_phone_2
        this.email = this.personDetails.email
        this.photo = this.personDetails.photo
