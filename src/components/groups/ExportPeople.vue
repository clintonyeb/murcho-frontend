<template>
  <div class="w-full container mx-auto">
    <div class="w-full control ml-1 mt-10">
      <div class="w-full">
        <label class="block text-grey text-sm font-bold mb-2" for="Format">
          Choose Export Format
        </label>
        <select name="Format" v-model="format" class="w-full bg-white text-grey-darker h-10 inline-flex border rounded-sm mb-1 pl-2"
