  ...
  <div class="w-full container mx-auto">
    <div class="mt-8  inline-flex justify-start w-full">
      <div class="w-full inline-flex justify-between items-center">
        <a class="inline-flex flex-auto items-center justify-center h-10 bg-blue-light rounded-sm text-white shadow-md mr-2 p-6"
          download :href="export_file_url" @click="$emit('cancel')">
