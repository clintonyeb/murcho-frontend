<template>
  <div>
    <div class="absolute flex items-center text-white text-sm font-bold px-4 py-3 w-full mb-4 animated tada" role="alert"
      ...
      <p class="pr-2">{{displayMessage}}</p>

      <span class="absolute pin-t pin-b pin-r mx-4 my-3" @click="shouldDisplayMessage = false">
        <svg class="fill-current h-4 w-4 m-auto text-white bg-grey-dark rounded-full" role="button" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
          <title>Close</title>
    ...
    <div class="container mx-auto lg:p-20 p-4 h-screen bg-pattern">
        ...
        <div class="mt-8 lg:mt-16">
          ...
          <div class="control mt-4 mb-4 h-16">
            <div class="h-12 inline-flex border max-w-full w-full rounded-sm relative" :class="getInputColor('Password')">
              ...
              <button class="p-1 h-12 w-12 absolute pin-r" @click.prevent="showPassword = !showPassword">
      ...
      <p class="text-center mt-8  text-lg">
        <a :href="landingPage" target="_blank" class="no-underline text-blue-dark hover:underline hover:text-blue-darker">
          Visit Platform Website
          <svg aria-hidden="true" data-prefix="fas" data-icon="external-link-alt" class="h-5 w-5 fill-current ml-1" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path fill="currentColor" d="M576 24v127.984c0 21.461-25.96 31.98-40.971 16.971l-35.707-35.709-243.523 243.523c-9.373 9.373-24.568 9.373-33.941 0l-22.627-22.627c-9.373-9.373-9.373-24.569 0-33.941L442.756 76.676l-35.703-35.705C391.982 25.9 402.656 0 424.024 0H552c13.255 0 24 10.745 24 24zM407.029 270.794l-16 16A23.999 23.999 0 0 0 384 303.765V448H64V128h264a24.003 24.003 0 0 0 16.97-7.029l16-16C376.089 89.851 365.381 64 344 64H48C21.49 64 0 85.49 0 112v352c0 26.51 21.49 48 48 48h352c26.51 0 48-21.49 48-48V287.764c0-21.382-25.852-32.09-40.971-16.97z"></path></svg>
          </a>
      </p>
    </div>
  </div>
